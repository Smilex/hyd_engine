...
foreign import ccall "entity_get_collision_objects" c_entity_get_collision_objects
	:: Ptr (a) -> Ptr (b)
...
entity_collision_check a b dx dy = c_collision_list_check_list ac bc dx dy
	where
		ac = c_entity_get_collision_objects a
		bc = c_entity_get_collision_objects b
